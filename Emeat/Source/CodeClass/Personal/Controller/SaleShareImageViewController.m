//
//  SaleShareImageViewController.m
//  Emeat
//
...
@interface SaleShareImageViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) UITableView *tableView;

@property (nonatomic,strong) SaleShareImageView *shareImageView;
@property (nonatomic,strong) ShareImageBottomView * shareBottomView;

@end

@implementation SaleShareImageViewController
...
- (SaleShareImageView *)shareImageView{
    if (!_shareImageView) {
        _shareImageView = [[SaleShareImageView alloc] initWithFrame:CGRectMake(0, 0, kWidth, kHeight)];
    }
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    [self.shareImageView configShareViewMainimage:self.productImageURL Title:self.productTitle Desc:self.productContent Prices:self.productPrices codeURL:[NSString stringWithFormat:@"%@/breaf/beef_detail.html?ds=%@&disuid=%@" ,baseUrl,self.detailsId ,self.distributorUid] PriceTypes:self.priceTypes];
