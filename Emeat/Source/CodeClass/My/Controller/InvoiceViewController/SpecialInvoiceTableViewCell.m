...
@implementation SpecialInvoiceTableViewCell
...
-(void)configWithModel:(InvoiceDetailsModel*)model{
    ...
    self.invoiceMoneyTextField.text =[NSString stringWithFormat:@"%.2f" , (float)[model.invoiceAmount integerValue]/100];
...
-(void)setLineViewUI{
    ...
    NSArray *labelArray =  @[@"备注:" ,@"公司电话:" ,@"公司地址" ,@"开户银行:" ,@"开户行账号" ,@"备注:" ,@"公司电话:" ,@"公司地址" ,@"开户银行:"];
...
-(UITextField *)companyPhoneNumTextField{
    if (!_companyPhoneNumTextField) {
        ...
        _companyPhoneNumTextField.placeholder = @"请填写公司电话";
...
-(UITextField *)companyAddressTextField{
    if (!_companyAddressTextField) {
        ...
        _companyAddressTextField.placeholder = @"请填写公司地址";
...
-(UITextField *)bankTextField{
    if (!_bankTextField) {
        ...
        _bankTextField.placeholder = @"请填写开户银行";
...
-(UITextField *)bankAccountTextField{
    if (!_bankAccountTextField) {
        ...
        _bankAccountTextField.placeholder = @"请填写开户行账号";
