...
-(void)startAnimationandView:(UIView *)view andRect:(CGRect)rect andFinisnRect:(CGPoint)finishPoint topView:(UIView *)topView andFinishBlock:(animationFinisnBlock)completion
{
    //图层
...
//    }
    ...
    // 添加layer到顶层视图控制器上
    [topView.layer addSublayer:_layer];
